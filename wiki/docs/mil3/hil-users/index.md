...
- :material-file-pdf-box: [Control Desk](../../assets/mil3/25_HIL_Users/25_Control_Desk.pdf) — PDF, 4.0 MB
- :material-file-pdf-box: [Control desk Presentazione Veronica](../../assets/mil3/25_HIL_Users/25_Control_desk_Presentazione_Veronica.pdf) — PDF, 3.6 MB
- :material-file-pdf-box: [HIL User](../../assets/mil3/25_HIL_Users/25_HIL_User.pdf) — PDF, 1.1 MB
